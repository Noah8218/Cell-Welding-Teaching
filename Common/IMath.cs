...
namespace IntelligentFactory
{
    public static class IMath
    {
...
#if EURESYS
        public static double GetShortestDistance(Euresys.Open_eVision_2_14.EPoint point, Euresys.Open_eVision_2_14.EPoint listStartPoint, Euresys.Open_eVision_2_14.EPoint lineEndPoint, out Euresys.Open_eVision_2_14.EPoint closestPoint) 
        { 
            ...
            if (t < 0) 
            {
                closestPoint = new Euresys.Open_eVision_2_14.EPoint(listStartPoint.X, listStartPoint.Y);
                dx = point.X - listStartPoint.X; dy = point.Y - listStartPoint.Y; 
            } 
            else if (t > 1) 
            {
                closestPoint = new Euresys.Open_eVision_2_14.EPoint(lineEndPoint.X, lineEndPoint.Y); dx = point.X - lineEndPoint.X; dy = point.Y - lineEndPoint.Y; 
            } 
            else
            { 
                closestPoint = new Euresys.Open_eVision_2_14.EPoint(listStartPoint.X + t * dx, listStartPoint.Y + t * dy); dx = point.X - closestPoint.X; dy = point.Y - closestPoint.Y;
            }
        ...
        public static double GetDistanceLineToPoint(Euresys.Open_eVision_2_14.EPoint ptTarget, Euresys.Open_eVision_2_14.ELine Line)
        {
        ...
        public static double RoiAngle(Line BaseLien, Point ptCenter)
        {
            double d1 = 0;
            double d2 = 0;
