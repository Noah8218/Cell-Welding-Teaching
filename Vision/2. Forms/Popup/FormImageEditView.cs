...
{
    public partial class FormImageEditView : MetroForm
    {
        ...
        public FormImageEditView(Mat image, string strMode = "")
        {
            InitializeComponent();
        ...
        public FormImageEditView(Bitmap image, string strMode = "")
        {
            InitializeComponent();
        ...
        public FormImageEditView(Bitmap image, Double dDistance)
        {
            InitializeComponent();
        ...
        private void Form_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
               // ILogger.Add(LOG_TYPE.SYSTEM, "[OK] {0}==>{1}   Action ==> {2}", MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name);
